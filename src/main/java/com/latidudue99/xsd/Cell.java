 ...
 *         &lt;element name="CellValue" type="{urn:crystal-reports:schemas:report-detail}CellValue"/>
 *       &lt;/sequence>
...
public class Cell {
    ...
    @Generated(value = "com.sun.tools.internal.xjc.Driver", date = "2019-08-26T03:23:46+01:00", comments = "JAXB RI v2.2.8-b130911.1802")
    protected List<CellValue> cellValue;
     ...
     * This is why there is not a <CODE>set</CODE> method for the cellValue property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCellValue().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<CellValue> getCellValue() {
        if (cellValue == null) {
            cellValue = new ArrayList<CellValue>();
        }
